...
ServerEvents.recipes(e => {
    ...
    // Hollow Logs -> Sticks (makes half as many as regular logs)
    e.shaped(
      "8x stick",
        [
          "H",
    ...
    // Hollow Logs -> 4 Mini Charcoal (1/2 of a Charcoal)
    e.smelting("4x minicoal:mini_charcoal", "#cookcraft:burnable_hollow_logs", 0.1).id("kubejs:hollow_charcoal")
